"use client";
import styles from './jastipers.module.css';
import { useEffect, useState } from 'react';
import { useRouter } from 'next/navigation';

export default function jastipers() {
  ...
  return (
    <div className={styles.container}>
        <select onChange={handleChange} className={styles.dropdownNavigate}>
          <option value="">Jastipers</option>
          <option value="/orders">Orders</option>
          <option value="/vendors">Vendors</option>
        </select>
        <h1 className={styles.title}>Perserikatan Jastiper ITBSS</h1>
        <h2 className={styles.subtitle}>List of Jastiper</h2>
        <button
